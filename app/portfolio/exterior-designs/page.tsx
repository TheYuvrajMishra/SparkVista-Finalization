  ...
  return (
    <main className="bg-[#0D0D0D] text-white/90 min-h-screen">
      ...
      <div className="container pt-20 mb-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          style={{
            backgroundImage: `url("https://cdn.dribbble.com/userupload/6108811/file/original-858ea008bdd4b3bdc742c3d814d4b7a0.jpg")`,
          }}
        ...
        <div className="container pt-32 mb-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="mt-4 text-zinc-400">
              A curated collection of our finest Exterior design projects.
            </p>
          </section>
            ...
            {interiorProjects.map((project, index) => (
              ...
              >
                ...
                <div className="w-full md:w-1/2 text-center md:text-left">
                  ...
                  <Link
                    href={`/portfolio/exterior-designs/${project.id}`} // Links to the detail page
